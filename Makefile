...
HDR    = src/qma.h src/ecache.h src/kvq.h src/json.h src/toolparse.h src/tools.h src/thermal.h src/selfctx.h src/intern.h src/cl.h
...
test: tests/test_toolparse tests/test_intern tests/cltest
